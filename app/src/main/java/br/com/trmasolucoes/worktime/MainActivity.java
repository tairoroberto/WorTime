...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fabSoundCloud = (FloatingActionButton) findViewById(R.id.fab_sound_cloud);
        FloatingActionButton fabYoutube = (FloatingActionButton) findViewById(R.id.fab_youtube);
        FloatingActionButton fabGoogle_plus = (FloatingActionButton) findViewById(R.id.fab_google_plus);
        FloatingActionButton fabFacebook = (FloatingActionButton) findViewById(R.id.fab_facebook);

        fabSoundCloud.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        fabGoogle_plus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
